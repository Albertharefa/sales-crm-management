  ...
  return (
    <div data-testid="order-monitoring-page">
      ...
      <div className="mb-4 grid grid-cols-[minmax(280px,1fr)_145px_175px_150px_245px] gap-2 overflow-x-auto border-y border-slate-200 bg-white p-3">
        ...
        <select value={etaFilter} onChange={(event) => setEtaFilter(event.target.value)} className={`${selectClass} h-9 min-w-0`}><option value="">Semua indikator ETA</option><option value="Overdue">Overdue</option><option value="Due Soon">Due Soon</option><option value="Selesai">Selesai</option></select>
