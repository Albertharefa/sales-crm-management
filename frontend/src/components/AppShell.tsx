...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-svh bg-slate-50 text-slate-900" data-testid="crm-app-shell">
    ...
    <aside className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-[radial-gradient(circle_at_15%_5%,rgba(245,158,11,.22),transparent_28%),radial-gradient(circle_at_90%_55%,rgba(185,28,28,.28),transparent_35%),linear-gradient(165deg,#06183f_0%,#102a63_42%,#641b35_76%,#8a5a16_100%)] text-white shadow-2xl shadow-slate-950/30 transition-transform duration-200 lg:translate-x-0 ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`} data-testid="sidebar-navigation">
