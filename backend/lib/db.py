...
async def _ensure_indexes():
    ...
    indexes = {
        ...
        "customers": [
            ...
            ([('sales_id', 1), ('created_at', -1)], "customers_sales_created"),
            ([('name', 1)], "customers_name"),
            ([('is_demo', 1)], "customers_demo"),
            ([('created_at', -1)], "customers_created"),
        ],
        "contacts": [
            ([('created_at', -1)], "contacts_created"),
            ([('sales_id', 1), ('created_at', -1)], "contacts_sales_created"),
        ],
        "leads": [
            ([('created_at', -1)], "leads_created"),
            ([('sales_id', 1), ('created_at', -1)], "leads_sales_created"),
        ],
        "products": [
            ([('id', 1)], "products_id"),
        ...
        "opportunities": [
            ...
            ([('sales_id', 1), ('created_at', -1)], "opportunities_sales_created"),
            ([('sales_id', 1), ('stage', 1), ('created_at', -1)], "opportunities_sales_stage_created"),
            ([('customer_id', 1), ('created_at', -1)], "opportunities_customer_created"),
            ([('stage', 1), ('status', 1)], "opportunities_stage_status"),
            ([('created_at', -1)], "opportunities_created"),
        ...
        "activities": [
            ...
            ([('sales_id', 1), ('date', -1)], "activities_sales_date"),
            ([('status', 1), ('type', 1)], "activities_status_type"),
            ([('date', -1)], "activities_date"),
